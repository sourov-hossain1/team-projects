    ...
    <div className="border-2 border-slate-300 w-2/5 mt-5 mx-auto">
      ...
      <div className="px-5 mx-auto w-96 grid grid-cols-1 gap-1 text-xl text-white py-5">
        ...
        <div className="grid grid-cols-1 gap-1 mb-3">
          ...
          <div className="bg-sky-700 p-2 flex pl-4 items-center  rounded-md gap-2 cursor-pointer">
            <FaLinkedin className="w-6 h-6"></FaLinkedin>
            <p>Continue with Linkedin</p>
          </div>
          <div className="bg-sky-500 p-2 flex pl-4 items-center  rounded-md gap-2 cursor-pointer">
